...
create table spurious_vms ( id int(11) not null auto_increment, vm varchar(200) not null, primary key (id));

create table alien_vault_black (ip varchar(100) not null, description varchar(200) not null, country varchar(200) not null);
