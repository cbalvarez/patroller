...
object Dependencies {
  ...
  val jline = "org.scala-lang" % "jline" % "2.10.2"
  ...
  val scalaUtil = "com.despegar" %% "scala-util" % "0.1.1"
  val logbackUtil = "com.despegar" %% "scala-logback-util" % "0.2"
  val getOpt = "org.rogach" % "scallop_2.10" % "0.9.5"
  ...
  val scalatra =   "org.scalatra" %% "scalatra" % "2.2.2"
  ...
  private val hectorCore = "org.hectorclient" % "hector-core" % "1.1-2" excludeAll (hectorExclusions: _*)
  ...
  val Compile = Seq(commonsCodec, logback, scalaCompiler, jline, scalajTime, jodaTime, jodaConver,
    scalaLogging, scalaUtil, logbackUtil, getOpt, httpClient, mail, liftJson, scalatra, jetty, javax, asyncHttpClient, hectorCore, 
